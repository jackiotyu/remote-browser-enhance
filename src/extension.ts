...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('remoteBrowserEnhance.disconnect', () => {
            remoteTree
                .endSession()
    ...
    // Register filter
    context.subscriptions.push(
        vscode.commands.registerCommand('remoteBrowserEnhance.filter', () => {
    ...
    // Register makeRoot
    context.subscriptions.push(
        vscode.commands.registerCommand('remoteBrowserEnhance.makeRoot', (node: any) => {
            if (node) {
